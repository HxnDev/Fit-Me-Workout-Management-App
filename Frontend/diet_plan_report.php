...
?>
	...
	<form method = "POST" action="search_food.php">
		<label for = "theday"> Choose a day of the week</label>
	...
	<div class="bg-text">
		...
		<h2 style = "font-size:50px">Your diet plan</h2>
		
		<p>We need to make sure your calorie intake is under <?php echo $ni ?></p>
