...
<body>
	<div class="bg-image"></div>
		...
		<div class="bg-text">
			...
			<form method = "POST" action="login_ex.php">
...
<?php  // creating a database connection 
	...
	if (isset($_POST['uid']))
	{
	   ...
	   if($con) 
		 ...
		 if ($len == 1)
		 {
			 echo "<div class=\"bg-text\"><form method = \"POST\" action=\"exercise_plan.php\"><input type=\"text\" name = \"id\" value =".$val." ><br><input type = \"submit\" value= \"Press Me\"></form>";
