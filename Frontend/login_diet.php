...
<body>
	<div class="bg-image"></div>
		...
		<div class="bg-text">
			...
			<form method = "POST" action="login_diet.php">
...
<?php  // creating a database connection 
	...
	if (isset($_POST['uid']))
	{
	   ...
	   if($con) 
		 ...
		 if ($len == 1)
		 {
			 echo "<div class=\"bg-text\"><form method = \"POST\" action=\"diet_plan_report.php\"><input type=\"text\" name = \"id\" value =".$val." ><br><input type = \"submit\" value= \"Press Me\"></form>";
			 //echo"<div class=\"bg-text\"><a href=\"http://localhost/project/diet_plan_report.php\">PRESS ME</a></div>";
